...
export function OwnerSidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex flex-col w-64 shrink-0 bg-[#161b22]/90 backdrop-blur-xl border-r border-white/10 p-5 space-y-6 sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto">
        {/* Sidebar Header */}
