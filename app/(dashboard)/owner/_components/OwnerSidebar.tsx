...
export function OwnerSidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex flex-col w-64 shrink-0 bg-gradient-to-b from-[#161b22]/95 to-[#0f141a]/95 backdrop-blur-xl border-r border-white/10 p-5 space-y-6 fixed top-16 left-0 h-[calc(100vh-4rem)] overflow-y-auto animate-fade-in z-40">
        {/* Sidebar Header */}
