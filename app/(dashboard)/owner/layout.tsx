...
export default function OwnerLayout({
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] bg-[#051424] text-slate-100 font-sans overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row min-h-[calc(100vh-4rem)] w-full">
        <OwnerSidebar />
        <main className="flex-1 min-w-0 animate-page-enter md:ml-64 w-full max-w-full">
          {children}
        </main>
      </div>
    </div>
